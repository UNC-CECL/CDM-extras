...
data_sub_dir = parent_dir + 'DATA'

if not os.path.exists(data_sub_dir):
	os.mkdir(data_sub_dir);    # make data sub-sub-directory for simulation
...
wind_fraction = 1.0;        # fraction of the year wind is above threshold (only used for time scales) such that real time is Nt*dt_max / wind.fraction
...
f = open(parent_dir + 'params.par', 'w' )
f.write( '# \n');
